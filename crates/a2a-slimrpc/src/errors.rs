...
mod tests {
    ...
    fn test_a2a_error_to_rpc_error_mapping() {
        let cases = [
            ...
            (error_code::PUSH_NOTIFICATION_NOT_SUPPORTED, RpcCode::FailedPrecondition),
            (error_code::UNSUPPORTED_OPERATION, RpcCode::FailedPrecondition),
            (error_code::CONTENT_TYPE_NOT_SUPPORTED, RpcCode::InvalidArgument),
    ...
    fn test_a2a_error_to_rpc_error_extended_mapping() {
        let cases = [
            ...
            (error_code::EXTENDED_CARD_NOT_CONFIGURED, RpcCode::FailedPrecondition),
