...
//!
//! Sur les cibles natives (Linux / Windows / macOS) la commande complète est
//! disponible. Sur `wasm32-*` seul un stub minimal est construit : le binaire
//! n'a pas accès au système de fichiers ni aux threads OS nécessaires au
//! walker multi-threadé.
//!
//! Exemples (cible native) :
//!
...
// ===========================================================================
// Native entry point — full CLI logic.
// ===========================================================================
...
mod native {
    ...
    struct Args {
        ...
        /// Langages à traiter, séparés par des virgules
        /// (rust,ts,js,py,go,c,cpp,sh,md,toml,all).
        ...
        /// Désactive l'appel réseau de traduction (utile pour scrub seul ou
        /// offline).
        #[arg(long)]
        no_translate: bool,

        /// E-mail noreply joint aux requêtes MyMemory (quota porté à 50 000
        /// mots/jour).
        #[arg(long)]
        contact_email: Option<String>,

        /// Chemin du cache (par défaut :
        /// `<root>/.aphrody-translate-cache.json`).
        #[arg(long)]
...
// ===========================================================================
// Native main — delegate to the native module.
// ===========================================================================
#[cfg(not(target_arch = "wasm32"))]
...
// ===========================================================================
// wasm32 stub — the file-system walker, tokio "full" runtime, rayon, clap,
// ignore, and tracing-subscriber are all unavailable on wasm32. Expose a
// minimal entry point that prints the crate version so the binary at least
// links and reports its identity.
// ===========================================================================
