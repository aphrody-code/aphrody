...
@Component({
    ...
    template: `
        <section class="card">
            ...
            <p class="hint">
                Éditez la configuration JSON de l'agent sélectionné. La validation JSON s'effectue
                avant l'enregistrement — un JSON invalide est refusé et le fichier existant reste
                intact.
            </p>
            ...
            <div class="selector">
                @for (c of choices; track c.which) {
                    <button
                        class="choice"
                        [class.sel]="which() === c.which"
                        (click)="select(c.which)"
                    >
            ...
            @if (hostUnavailable()) {
                ...
                <div class="status-row">
                    @if (jsonError()) {
                        ...
                        <span class="ok-text"
                            ><mat-icon class="material-symbols-outlined">check_circle</mat-icon>JSON
                            valide</span
                        >
                    }
                </div>
