    ...
    template: `
        <div class="page">
            <header class="head">
                ...
                >
                    <mat-icon class="material-symbols-outlined" [class.spin]="anyLoading()"
                        >refresh</mat-icon
                    >
                </button>
            </header>
            ...
            <div class="cards">
                <div class="card">
                    ...
                    <a class="quick" routerLink="/settings" [queryParams]="{ tab: 'agents' }"
                        >Configurer</a
                    >
                </div>
                ...
                <div class="card">
                    ...
                    <a class="quick" routerLink="/settings" [queryParams]="{ tab: 'actions' }"
                        >Piloter</a
                    >
                </div>
                ...
                <div class="card">
                    ...
                    <a class="quick" routerLink="/settings" [queryParams]="{ tab: 'conversation' }"
                        >Changer</a
                    >
                </div>
            </div>
    ...
    private async loadAntigravity(): Promise<void> {
        try {
            ...
            if (res.code === 0 && out.startsWith("{")) {
                ...
                this.antigravity.set({
                    status: "ok",
                    detail: `Installé — v${j.ideVersion ?? "?"}`,
                });
