    ...
    <mat-card class="run-card" appearance="outlined">
      <div class="run-row">
        ...
        <div class="run-text">
          ...
          <span class="run-hint">Résultats web sans clé ni navigateur, via DuckDuckGo (aphrody search).</span>
        </div>
      </div>
      <div class="run-input">
        <input
        ...
        />
        <button mat-raised-button color="primary" (click)="run()" [disabled]="running() || !query().trim()">
