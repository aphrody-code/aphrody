                    ...
                    @for (s of filtered(); track s.name) {
                        <div class="skill-card">
                            <div class="skill-row" (click)="open(s)">
                                <mat-icon class="material-symbols-outlined skill-glyph">{{
                                    icon(s.source)
                                }}</mat-icon>
                                ...
                                <button class="open-btn" aria-label="Ouvrir le SKILL.md">
                                    <mat-icon class="material-symbols-outlined">{{
                                        expanded() === s.name ? "expand_less" : "unfold_more"
                                    }}</mat-icon>
                                </button>
                            </div>
                            @if (expanded() === s.name) {
                                <div class="skill-body">
                                    @if (bodyLoading()) {
                                        <span class="body-note"
                                            ><mat-icon class="material-symbols-outlined spin"
                                                >progress_activity</mat-icon
                                            >
                                            Lecture du SKILL.md…</span
                                        >
                                    } @else {
                                        <pre>{{ body() }}</pre>
                                    }
