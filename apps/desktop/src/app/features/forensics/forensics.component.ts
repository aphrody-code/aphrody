...
@Component({
  ...
  template: `
    <div class="page">
      <header class="head">
        <div class="head-icon"><mat-icon class="material-symbols-outlined">travel_explore</mat-icon></div>
        <div>
          <h1>Forensics</h1>
          <p>Extraction forensique reproductible (lecture seule, jamais de secrets en clair).</p>
        </div>
      </header>
