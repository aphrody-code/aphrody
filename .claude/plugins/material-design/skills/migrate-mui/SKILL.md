...
Measured on a real app (rpbey, 30 files): 108/113 icon usages auto-converted (96 %), 5 brand logos flagged.
...
- The real migration wall is `sx`/Emotion styling — measured at ~30 % of effort in the rpbey real-world case study (`migration/10-case-study-rpbey.md`).
