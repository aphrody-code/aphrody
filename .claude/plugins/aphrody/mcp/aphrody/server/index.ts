...
// GitHub and Context7 are intentionally NOT bundled here — they are
// external SaaS MCP servers. Install them separately if needed:
//   - GitHub: https://api.githubcopilot.com/mcp/  (streamable-http, OAuth)
//   - Context7: https://mcp.context7.com/mcp     (http, API key)
// Add them to ~/.claude/settings.json or per-project .claude/settings.json
// outside this plugin.
