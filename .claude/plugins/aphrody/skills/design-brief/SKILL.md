...
od:
  ...
  capabilities_required:
    - file_write
when_to_use: "User types \"/design-brief\", says \"design brief\", \"create a design brief\", \"ilang brief\", \"structured brief\", or asks for: Parse a structured design brief written in I-Lang protocol format into a concrete design spec. Eliminates ambiguity from vague requests like \"make it professional\" by requiring explicit dimensions: palette, typography, layout, mood, density, and constraints. Trigger keywords: \"design brief\", \"create a design brief\", \"ilang brief\", \"structured brief\"."
---

# Design Brief Skill

Mode `/goal` permanent : décider seul, ne pas s'arrêter avant DESIGN.md complet.

Parse a structured design brief into a concrete DESIGN.md and optional visual preview. Follow this workflow exactly.
...
Imported via the Open Design harvester (nexu-io/open-design, fork of google-labs-code/skills + community contributions); regenerated by `scripts/skills-harvest-open-design.ts`.
