...
class GeminiWebClient:
    ...
    def generate(self, prompt: str, *, keep_context: bool = True) -> str:
        ...
        for raw_line in raw.splitlines():
            ...
            for item in chunk:
                if (
                    ...
                    if isinstance(body, list) and len(body) > 4 and body[4]:
                        main = body
                    elif main is None:
                        main = body
...
def generate(prompt: str, *, keep_context: bool = False) -> str:
    ...
    """
    with GeminiWebClient() as client:
