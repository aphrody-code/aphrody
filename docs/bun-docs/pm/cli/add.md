...
Unlike other bun clients, Bun does not execute arbitrary lifecycle scripts for installed dependencies, such as `postinstall`. These scripts represent a potential security risk, as they can execute arbitrary code on your machine.
...
Bun supports a variety of protocols, including [`github`](https://docs.npmjs.com/cli/v9/configuring-bun/package-json#github-urls), [`git`](https://docs.npmjs.com/cli/v9/configuring-bun/package-json#git-urls-as-dependencies), `git+ssh`, `git+https`, and many more.
