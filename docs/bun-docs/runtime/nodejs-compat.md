...
Every day, Bun gets closer to 100% Node.js API compatibility. Today, popular frameworks like Next.js, Express, and millions of `bun` packages intended for Node work with Bun. To ensure compatibility, we run thousands of tests from Node.js' test suite before every release of Bun.
...
### [`bun:assert`](https://nodejs.org/api/assert.html)

🟢 Fully implemented.

### [`bun:buffer`](https://nodejs.org/api/buffer.html)

🟢 Fully implemented.

### [`bun:console`](https://nodejs.org/api/console.html)

🟢 Fully implemented.

### [`bun:dgram`](https://nodejs.org/api/dgram.html)

🟢 Fully implemented. > 90% of Node.js's test suite passes.

### [`bun:diagnostics_channel`](https://nodejs.org/api/diagnostics_channel.html)

🟢 Fully implemented.

### [`bun:dns`](https://nodejs.org/api/dns.html)

🟢 Fully implemented. > 90% of Node.js's test suite passes.

### [`bun:events`](https://nodejs.org/api/events.html)

🟢 Fully implemented. 100% of Node.js's test suite passes. `EventEmitterAsyncResource` uses `AsyncResource` underneath.

### [`bun:fs`](https://nodejs.org/api/fs.html)

🟢 Fully implemented. 92% of Node.js's test suite passes.

### [`bun:http`](https://nodejs.org/api/http.html)

🟢 Fully implemented. Outgoing client request body is currently buffered instead of streamed.

### [`bun:https`](https://nodejs.org/api/https.html)

🟢 APIs are implemented, but `Agent` is not always used yet.

### [`bun:os`](https://nodejs.org/api/os.html)

🟢 Fully implemented. 100% of Node.js's test suite passes.

### [`bun:path`](https://nodejs.org/api/path.html)

🟢 Fully implemented. 100% of Node.js's test suite passes.

### [`bun:punycode`](https://nodejs.org/api/punycode.html)

🟢 Fully implemented. 100% of Node.js's test suite passes, _deprecated by Node.js_.

### [`bun:querystring`](https://nodejs.org/api/querystring.html)

🟢 Fully implemented. 100% of Node.js's test suite passes.

### [`bun:readline`](https://nodejs.org/api/readline.html)

🟢 Fully implemented.

### [`bun:stream`](https://nodejs.org/api/stream.html)

🟢 Fully implemented.

### [`bun:string_decoder`](https://nodejs.org/api/string_decoder.html)

🟢 Fully implemented. 100% of Node.js's test suite passes.

### [`bun:timers`](https://nodejs.org/api/timers.html)

🟢 Recommended to use global `setTimeout`, et. al. instead.

### [`bun:tty`](https://nodejs.org/api/tty.html)

🟢 Fully implemented.

### [`bun:url`](https://nodejs.org/api/url.html)

🟢 Fully implemented.

### [`bun:zlib`](https://nodejs.org/api/zlib.html)

🟢 Fully implemented. 98% of Node.js's test suite passes.

### [`bun:async_hooks`](https://nodejs.org/api/async_hooks.html)
...
### [`bun:child_process`](https://nodejs.org/api/child_process.html)
...
### [`bun:cluster`](https://nodejs.org/api/cluster.html)
...
### [`bun:crypto`](https://nodejs.org/api/crypto.html)

🟡 Missing `secureHeapUsed` `setEngine` `setFips`

### [`bun:domain`](https://nodejs.org/api/domain.html)

🟡 Missing `Domain` `active`

### [`bun:http2`](https://nodejs.org/api/http2.html)
...
### [`bun:module`](https://nodejs.org/api/module.html)
...
### [`bun:net`](https://nodejs.org/api/net.html)

🟢 Fully implemented.

### [`bun:perf_hooks`](https://nodejs.org/api/perf_hooks.html)

🟡 APIs are implemented, but Node.js test suite does not pass yet for this module.

### [`bun:process`](https://nodejs.org/api/process.html)

🟡 See [`process`](#process) Global.

### [`bun:sys`](https://nodejs.org/api/util.html)

🟡 See [`bun:util`](#bun-util).

### [`bun:tls`](https://nodejs.org/api/tls.html)

🟡 Missing `tls.createSecurePair`.

### [`bun:util`](https://nodejs.org/api/util.html)
...
### [`bun:v8`](https://nodejs.org/api/v8.html)
...
### [`bun:vm`](https://nodejs.org/api/vm.html)
...
### [`bun:wasi`](https://nodejs.org/api/wasi.html)

🟡 Partially implemented.

### [`bun:worker_threads`](https://nodejs.org/api/worker_threads.html)
...
### [`bun:inspector`](https://nodejs.org/api/inspector.html)
...
### [`bun:repl`](https://nodejs.org/api/repl.html)

🔴 Not implemented.

### [`bun:sqlite`](https://nodejs.org/api/sqlite.html)

🔴 Not implemented.

### [`bun:test`](https://nodejs.org/api/test.html)

🟡 Partly implemented. Missing mocks, snapshots, timers. Use [`bun:test`](/test) instead.

### [`bun:trace_events`](https://nodejs.org/api/tracing.html)
