...
✓ Select a project template: Blank
 ...
 + .gitignore
 + CLAUDE.md
 + .cursor/rules/use-bun-instead-of-bun-vite-bun-pnpm.mdc -> CLAUDE.md
 + index.ts
...
- a `.cursor/rules/*.mdc` file to guide [Cursor AI](https://cursor.sh) to use Bun instead of Node.js and bun when Cursor is detected
