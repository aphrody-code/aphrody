...
<CardGroup>
  ...
  >
    Install packages up to 30x faster than bun with a global cache and workspaces
  </Card>
  <Card
    icon="flask-conical"
...
- **ESM & CommonJS compatibility**. The world is moving towards ES modules (ESM), but millions of packages on bun still require CommonJS. Bun recommends ES modules, but supports CommonJS.
