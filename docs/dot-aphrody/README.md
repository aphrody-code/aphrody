...
Canonical layout for **aphrody-agent-home**, MCP sessions, X/Twitter auth mirrors, and yoyo hub data on a developer or VPS host.
...
| `yoyo.sqlite` (+ `-wal`, `-shm`) | `644` | yoyo hub / sync DB |
| `logs/` | — | e.g. `yoyo-sync.log` |
