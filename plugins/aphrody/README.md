...
Ce dossier est désormais la source de vérité du plugin unifié compatible
Claude Code et Codex. Les deux clients partagent les mêmes skills et le même
serveur Rust `aphrody-mcp`; seuls leurs manifestes d'adaptation diffèrent.
