# @aphrody/gemini-app-aphrody

Pixel-perfect Next.js 16 App Router port of [gemini.google.com/app](https://gemini.google.com/app),
wired to the [`@aphrody/gemini-live-aphrody`](../gemini-live-aphrody/) SDK and the
[`crates/m3-tokens`](../../crates/m3-tokens/) design system.
...
- OAuth path (no `GEMINI_API_KEY` required) via `@aphrody/gemini-live-aphrody`
...
```bash
cd packages/gemini-app-aphrody
bun install
