...
# Tokens & theming Material Design 3 sur le Web (2026)
...
| ------------- | -------------------------------------------- | --------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| **Reference** | `--md-ref-*`                                 | Valeurs primitives concrètes (un hex, une famille de police, une taille)          | `--md-ref-palette-primary40`, `--md-ref-typeface-plain`                                         |
| **System**    | `--md-sys-*`                                 | Rôles/décisions du design system (couleur, typo, forme, élévation, motion, state) | `--md-sys-color-primary`, `--md-sys-typescale-body-medium-size`, `--md-sys-shape-corner-medium` |
| **Component** | `--md-<composant>-*` (PAS de préfixe `comp`) | Attribut d'un composant donné, qui retombe (fallback) sur un token système        | `--md-filled-button-container-color`, `--md-checkbox-outline-color`                             |
...
**Convention typographie** : `--md-sys-typescale-<scale>-<size>-<property>`.
...
Sources : [Design tokens – Material Design 3](https://m3.material.io/foundations/design-tokens), [Material Web – Theming](https://material-web.dev/theming/material-theming/), [Material Web – Color](https://material-web.dev/theming/color/).
...
Sources : [@material/material-color-utilities (npm)](https://www.npmjs.com/package/@material/material-color-utilities), [GitHub material-foundation/material-color-utilities](https://github.com/material-foundation/material-color-utilities).
...
- **CSS** : le plugin officiel produit des variables/styles Figma. Pour sortir directement des **CSS custom properties** conformes au spec M3, on passe par des plugins compagnons :
  ...
  - **Variable Export – CSS & JSON** — export multi-collections en CSS ou JSON.
...
## 5. Dark mode & contrast levels en CSS variables
...
### (b) Tailwind (mapping tokens → theme)
...
- `material-web/tokens/_md-sys-color.scss` : liste blanche (`$supported-tokens`) des color roles M3 — on y voit les **surface tokens récents** : `surface-bright`, `surface-dim`, `surface-container`, `surface-container-low/lowest/high/highest`, plus les `*-fixed` / `*-fixed-dim` et `inverse-*`.
- `material-web/tokens/_md-sys-typescale.scss` : tokens `--md-sys-typescale-<scale>-<size>-<property>` (ex. `body-large-font`, `display-large-weight`).
...
- `material-web/tokens/_md-comp-*.scss` (≈ 60 fichiers, ex. `_md-comp-filled-button.scss`, `_md-comp-checkbox.scss`) : définissent les **component tokens**, qui retombent sur les sys tokens.
...
### Les mixins qui émettent le CSS — `material-web/color/_color.scss`
...
- [Material Web – Theming](https://material-web.dev/theming/material-theming/) · [Material Web – Color](https://material-web.dev/theming/color/)
...
- [Material Theme Builder (Figma)](https://www.figma.com/community/plugin/1034969338659738588/material-theme-builder) · [GitHub material-theme-builder](https://github.com/material-foundation/material-theme-builder) · [m3-variable-exporter](https://www.figma.com/community/plugin/1357242754722607687/m3-variable-exporter)
- Repo local : `material-web/tokens/`, `material-web/color/_color.scss`, `material-web/typography/_typescale.scss`, `material-web/tokens/versions/v0_192/`
