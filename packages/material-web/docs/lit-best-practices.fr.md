...
## 4. Cycle de vie et performances
...
- ARIA corrige dans le shadow DOM (`role`, `aria-*`). Contrôles de formulaire : `ElementInternals` (`static formAssociated`, `attachInternals`, `setFormValue`, `setValidity`, `ariaLabel` via les éléments internes lorsque cela est pertinent).
