...
| #   | Document                                                               | Contenu                                                                                                                                                                                                                                                                           |
| --- | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 01  | [`01-md3-spec-foundations.md`](./01-md3-spec-foundations.md)           | **Fondations de la spec MD3** : couleur HCT & Dynamic Color, design tokens (`ref`/`sys`/`comp`), type scale, élévation, shape, motion, state layer, window size classes, a11y. M3 Expressif (2025).                                                                               |
| 02  | [`02-tokens-theming-web.md`](./02-tokens-theming-web.md)               | **Tokens & theming sur le web** : du token aux propriétés personnalisées CSS `--md-sys-*`, `material-color-utilities` (HCT, `themeFromSourceColor`, `applyTheme`), Material Theme Builder, web couleur dynamique, mode sombre & contraste, intégration CSS/Tailwind/material-web. |
...
| ------------------------ | ------------------------------------------------ | ------------------------------------ | ------------------------------------------------------ |
| `matériel-web/`          | Composants Web Lit (fork `aphrody` enrichi)      | `@matériel/web` 2.4.1                | **MD3 canonique** (tokens + composants), upstream gelé |
| `matériel-ui/`           | Les composants réagissent                        | `@mui/matériel` 9.0.1                | Material **2**, pas de M3                              |
| `matériel-vent arrière/` | Composants React/HTML + Tailwind                 | 2.1.10 / 2.3.2 (v3 une version bêta) | Material **2**, gelé                                   |
| `shadcn-ui/`             | Copier-coller de Registry React (Radix)          | CLI 4.7.0                            | **Non-Material** ; bon socle DIY                       |
| `tailwindcss/`           | Utilitaire Moteur CSS d'abord (oxyde de rouille) | 4.3.0                                | Neutre ; point d'ancrage `@theme`                      |
