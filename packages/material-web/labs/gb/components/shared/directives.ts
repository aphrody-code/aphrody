 ...
 *     cleanup.
 */
export type SetupElementFunction = (element: HTMLElement, opts: { signal: AbortSignal }) => void;
 ...
 */
export function createElementDirective(setupElement: SetupElementFunction): () => DirectiveResult {
  return directive(
...
abstract class SetupElementDirective extends AsyncDirective {
   ...
   */
  protected setupElement?: (element: HTMLElement, opts: { signal: AbortSignal }) => void;
