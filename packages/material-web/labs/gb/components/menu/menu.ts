 ...
 */
export function setupMenu(menu: HTMLElement, opts?: { signal?: AbortSignal }): void {
 ...
 * @param opts Setup options, supports a cleanup `signal`.
 */
export function setupMenuItem(menuItem: HTMLElement, opts?: { signal?: AbortSignal }): void {
