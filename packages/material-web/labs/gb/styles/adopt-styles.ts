 ...
 * @example
 * ```ts
 * import { styles as globalStylesheet } from "./stylesheet.cssresult.js";
 *
 ...
 * @example
 * ```ts
 * import { styles as hostClasses } from "./stylesheet.cssresult.js";
 *
...
export function adoptStyles(
  ...
  const stylesheets: CSSStyleSheet[] = styles.map((cssResultOrNative) =>
    isCSSResult(cssResultOrNative) ? cssResultOrNative.styleSheet! : cssResultOrNative,
  );
