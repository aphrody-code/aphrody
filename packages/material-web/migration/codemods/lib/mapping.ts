 ...
 * `packages/react/md-elements.txt`). Mapping confronté à une app réelle :
 * `migration/10-case-study-rpbey.md`.
 *
...
export const SIMPLE_COMPONENTS: Record<string, string> = {
  ...
  Paper: "MdSurface",
  // --- composants confirmés par le cas réel rpbey (cf. 10-case-study-rpbey.md) ---
...
export const LAYOUT_COMPONENTS: Record<string, string> = {
  ...
  // manuellement reste préférable (cf. 10-case-study-rpbey.md).
...
export const SLOTTED_CHILDREN: Record<string, SlotRule> = {
  ...
  // Alert : AlertTitle -> titre slotté (cf. cas réel rpbey)
