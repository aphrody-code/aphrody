...
const libPath = join(import.meta.dir, "../../target/x86_64-unknown-linux-gnu/release/libbun_rs.so");
...
console.log(`-> Rust FFI bun_rs_add: ${durationFFI.toFixed(2)}ms (${(ITERATIONS / durationFFI / 1000).toFixed(2)}M ops/sec)`);
...
console.log(`-> Pure JS add: ${durationJS.toFixed(2)}ms (${(ITERATIONS / durationJS / 1000).toFixed(2)}M ops/sec)`);
